...
constraint chkEmpSalary check (EmpSalary between 3000 and 10000),
constraint chkEmpQual check (EmpQualification= "BSC" or EmpQualification= "MSC" or EmpQualification= "MPHIL" or EmpQualification= "PHD"),
constraint chkEmpTel check (EmpTel REGEXP "[0-9]{3}+[-]+[0-9]{4}+[-]+[0-9]{3}$"),
